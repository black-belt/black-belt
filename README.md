...
### a) 메인페이지
 ...
 메인페이지는 크게 `연습모드 / 심사모드 / 겨루기` 로 나뉩니다.  
 태권도 영상을 배경으로 두어 웅장한 느낌을 더했습니다. 
...
유저목록에는 유저의 상태가 `Y/T/B/N (로그인/심사중/배틀중/로그아웃)` 네가지로 나타납니다. 로그인(Y)을 제외한 모든 경우에는 배틀을 신청할 수 없습니다.  
겨루기 가능한 상태의 유저에게 겨루기 신청을 보내봅시다!  
상대가 `수락 시`, 게스트로서 호스트의 대기방에 초대되며, 호스트가 '게임시작'을 누르면 게임이 시작되고 배틀방으로 이동합니다.   
![겨루기배틀](https://user-images.githubusercontent.com/67628725/162375953-de380490-4eca-44ff-9886-24777b72ae69.gif)  
  배틀방으로 입장하면, 예의를 갖춰 `태권도 기본동작`을 수행해야 배틀을 시작할 수 있습니다.  
